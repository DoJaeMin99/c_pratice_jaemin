    ...
    public partial class fMain : Form
    {
        ...
        private void btLogin_Click(object sender, EventArgs e)
        {
            ...
            if(result == System.Windows.Forms.DialogResult.OK)
            {
                ...
                //2. 입.출금 등록 버튼을 활성화
                btIN.Enabled = true;   //입금 버튼 활성화
                btDelete.Enabled = true;  //출금 버튼 활성화
            }
            else
            {
                //로그인 실패함.
                ...
                //2. 입/출금 등록 버튼을 비활성화
                btIN.Enabled = false;   //입금 버튼 비활성화
                btDelete.Enabled = false;  //출금 버튼 비활성화
            }
        }
        ...
        private void btEdit_Click(object sender, EventArgs e)
        {
            ...
            if (입금액 != "")
            {
                ...
                {
                    //현재선택된 자료를 업데이트 합니다.
                    lv.SubItems[0].Text = f.dtDate.Value.ToShortDateString();   //2023-07-07
